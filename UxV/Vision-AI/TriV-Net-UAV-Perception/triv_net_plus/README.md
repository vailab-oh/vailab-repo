...
[Project overview](../README.md) | [TriV-Net (coming soon)](../triv_net/README.md)

All commands below are run from `triv_net_plus/` after the installation step.
...
TartanAir Old Town and Neighborhood data, then place the files under `triv_net_plus/data/` in the following
layout:
...
Run the unit tests from the `triv_net_plus/` directory:
